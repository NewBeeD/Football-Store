  ...
  return ( 
    ...
    <div className="text-center">
      ...
      <div className="mt-8 flex flex-row justify-center flex-wrap md:space-x-8 font-barlow font-semibold border-2 border-green-900 h-[50vh]">
        ...
        <div className="flex flex-col border-2 border-red-900 shadow-xl hover:scale-110 duration-300 rounded-2xl">
          <img src="" alt="Cleats" className="rounded-2x object-cover w-1/6"/>
        ...
        {/* <div className="flex flex-col border-2 shadow-xl hover:scale-110 duration-300 rounded-2xl w-2/5">
          <img src="https://static.nike.com/a/images/t_PDP_864_v1/f_auto,b_rgb:f5f5f5/a86dfc91-a8e7-4118-a631-06d26f53fdaf/phantom-gt2-dynamic-fit-elite-fg-firm-ground-soccer-cleats-Lj0t9H.png" alt="Cleats" className="rounded-2xl"/>
