...
import nike from '../images/Players/Players'
  ...
  return ( 
    ...
    <>
      ...
      <div className="flex justify-center mt-6">
        ...
        <section className={`brand-ad md:h-[36rem] md:max-w-[80rem] h-[20rem] w-[90%] flex flex-row justify-center items-center tracking-wider border-2 border-white bg-cover rounded-3xl shadow-2xl hover:scale-110 transition duration-500 ease-in-out`} style={styles()}>

          <div className="md:text-6xl text-3xl text-red-900 font-extrabold tracking-widest" style={{backgroundImage: "url('../images/Nike/Nike2.png')"}}>Shop<span className="brand text-yellow-600">{ brand }</span></div>
